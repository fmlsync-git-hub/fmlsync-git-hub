...
interface HealthAppBottomNavProps {
    currentUser: User & UserSettings;
    activeScreen: Screen;
    onNavigate: (screen: Screen) => void;
}

const HealthAppBottomNav: React.FC<HealthAppBottomNavProps> = ({ currentUser, activeScreen, onNavigate }) => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 h-20 bg-sidebar border-t border-border-default flex justify-around items-center shadow-[0_-5px_15px_-5px_rgba(0,0,0,0.05)] z-30 lg:hidden">
            {userNavItems.map(item => {
                ...
                return (
                    ...
                    >
                        <div className={`p-2 rounded-full transition-colors ${isActive ? 'bg-primary/10' : ''}`}>
...
export default HealthAppBottomNav;
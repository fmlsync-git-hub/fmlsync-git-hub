...
import MindfulnessAppHeader from '../components/mindfulness_app_layout/MindfulnessAppHeader';
import MindfulnessAppBottomNav from '../components/mindfulness_app_layout/MindfulnessAppBottomNav';
...
interface MindfulnessAppLayoutProps {
  currentUser: User & UserSettings;
  onLogout: () => void;
}

const MindfulnessAppLayout: React.FC<MindfulnessAppLayoutProps> = ({ currentUser, onLogout }) => {
...
export default MindfulnessAppLayout;

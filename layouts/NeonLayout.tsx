...
import NeonSidebar from '../components/neon_layout/NeonSidebar';
import NeonHeader from '../components/neon_layout/NeonHeader';
...
const NeonLayout: React.FC<NeonLayoutProps> = ({ currentUser, onLogout }) => {
    ...
    <div className="min-h-screen w-full bg-background-margin flex flex-col items-center">
        <div className={`h-screen w-full relative bg-background text-on-background flex flex-col ${getContainerClass()}`}>
            ...
            <button 
                ...
                className="fixed bottom-6 right-6 bg-primary text-white rounded-full p-4 shadow-lg hover:bg-primary-dark transition-transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary z-30"

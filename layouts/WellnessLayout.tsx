...
import WellnessHeader from '../components/wellness_layout/WellnessHeader';
import WellnessBottomNav from '../components/wellness_layout/WellnessBottomNav';
...
const WellnessLayout: React.FC<WellnessLayoutProps> = ({ currentUser, onLogout }) => {

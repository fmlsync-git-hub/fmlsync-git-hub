...
import { createNewUserCF, createNewUserClientSide } from '../services/firebase';
...
export const AdminAddNewUserModal: React.FC<AdminAddNewUserModalProps> = ({ isOpen, onClose, onSave }) => {
    ...
    // Intelligent Auto-Assignment Logic for Admin view as well
    useEffect(() => {
    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Use the client-side version for training/demo stability
            await createNewUserClientSide(username, password, role, email, contactInfo, companyId);
    ...
    React.useEffect(() => {
        if (!isOpen) {
            ...
            // Default companyId to first company if creating a client manually and nothing auto-selected

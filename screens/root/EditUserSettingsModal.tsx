...
export const EditUserSettingsModal: React.FC<EditUserSettingsModalProps> = ({ user, onClose, onSave }) => {
    ...
    const handleSave = async () => {
        ...
        const settingsToSave = {
            isActive: isProtectedRole ? true : isActive,
            disabledMenus
        };
        await updateUserSettings(user.username, settingsToSave);
        setIsSaving(false);
        onSave();
        onClose();
    };
